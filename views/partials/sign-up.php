<div id="signup_wizard">
	<p class="message">You need to complete the set up wizard you can start using the Real Estate Website Builder plugin. It takes 2 mintues and ensures your real estate website will work properly.</p>	
	<div class="clear"></div>
